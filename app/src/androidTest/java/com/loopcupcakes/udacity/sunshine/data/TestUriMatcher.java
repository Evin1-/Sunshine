package com.loopcupcakes.udacity.sunshine.data;
/*
...
import com.loopcupcakes.udacity.sunshine.provider.WeatherProvider;
...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final String TAG = "TestUriMatcherTAG_";
    ...
    public void testUriMatcher() {
        ...
        Log.d(TAG, "testUriMatcher: " + TEST_WEATHER_DIR);
        Log.d(TAG, "testUriMatcher: " + TEST_WEATHER_WITH_LOCATION_DIR);
        Log.d(TAG, "testUriMatcher: " + TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR);
        Log.d(TAG, "testUriMatcher: " + TEST_LOCATION_DIR);
